function [Result_table, Result_table_summary] = RESIDUAL(simulation_size, Data_x, y_real, sample_size, p, beta_real,...
                          k_min, k_max, num_time)
%-------------------------------------函数功能----------------------------------------%
...
for i = 1:simulation_size
    y = y_real(:, i);
    x = Data_x(:,:,i);
    [result] = residual_single_regression(x, y, sample_size, p, beta_real, k_min, k_max, num_time);
